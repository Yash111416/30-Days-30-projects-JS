...
const ageAll = inventors.reduce((total, inventor) => {
...
if (category) { // Check if the element with class '.mw-category' exists
    ...
    console.error("The element with class '.mw-category' was not found.");
}
